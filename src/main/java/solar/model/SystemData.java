...
public class SystemData {
    ...
    public static final SolarArray pv1 = new SolarArray("West", "10 off 340 W", 10 * 1.669 * 0.996, 32, 92.0, 20.0 / 100);
    public static final SolarArray pv2 = new SolarArray("East", "10 off 340 W", 10 * 1.669 * 0.996, 32, 272.0, 20.0 / 100);

    // Array of 9 PV-TD185MF5 on garage
    // Angle measured from google maps as 2.0 degrees
    // tilt from memory of design
    public static final SolarArray pv3 = new SolarArray("South", "9 off 185 W", 9 * 1.65 * 0.83, 35, 2.0, 13.4 / 100);
